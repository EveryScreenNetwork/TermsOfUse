# 21세기 연구소 이용약관 및 규칙 (2024. 10. 31. 갱신)
...
또한, 연구소 이용에 있어서 사용자의 피로감을 줄이기 위해, 다음과 같은 내용을 **cw 없이, 혹은 '공개' 이상의 공개 범위로 게시하는 것**을 금지합니다. 이를 어길 시 해당 게시물 삭제 및 안내 DM이 갈 수 있습니다.
...
- 타인, 혹은 작품에 대한 공격적이거나 불호 의사를 담은 게시물 (사이버불링 포함, 타인의 의견은 캡처해서 비난의 의도로 게시하는 행위 포함)

...
**21세기 연구소**(이하 연구소)는 정보와 지식의 자유를 갈구하는 모든 이들을 위한 SNS로, 연구소에서 발행하는 모든 자료들은 별다른 첨언이 없는 한 퍼블릭 도메인(Public Domain)을 지향합니다.
연구소의 모든 아이콘들은 기본적으로 퍼블릭 도메인과 CCO 라이선스이며, 이외의 라이선스를 이용한 파일을 사용할 시 각 라이선스에 따라 저작권을 명시합니다.
